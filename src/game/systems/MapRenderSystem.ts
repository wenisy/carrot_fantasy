...
export class MapRenderSystem extends System {
    ...
    private createMapRender(): void {
        ...
        console.log('Creating map render with component:', mapComponent)
        console.log('Map size:', mapComponent.width, 'x', mapComponent.height)
        console.log('Waypoints:', mapComponent.waypoints)
